...
export class MiniTalkingViewWidget extends ReactWidget {
  ...
  render(): JSX.Element {
    return (
      <div>
        <div
          className={`nbwhisper-mini-talking-view-button-palette ${
        ...
        <div
          className={`nbwhisper-mini-talking-view-display-palette ${
        ...
        >
          ...
          <div
            className={`nbwhisper-mini-talking-view-display-area ${
              this._isDisplayAreaVisible ? 'active' : 'leave'
            }`}
